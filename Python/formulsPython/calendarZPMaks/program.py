...
def update_calendar(month, free_days, not_free_days):
...
# free_days_november = [21, 22, 25, 26, 29, 30]
# not_free_days_november = [19, 20, 23, 24, 27, 28]
...
def show_november():
    update_calendar(11, free_days_november, not_free_days_november)  # Ноябрь


def show_december():
    update_calendar(12, free_days_december, not_free_days_december)  # Декабрь


def show_january():
    update_calendar(1, free_days_january, not_free_days_january)  # Январь


def show_february():
    update_calendar(2, free_days_february, not_free_days_february)  # Февраль


def show_march():
    update_calendar(3, free_days_march, not_free_days_march)  # Март
