    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, null=True, verbose_name='Name is usesr:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ImageField(blank=True, null=True, upload_to='product/%Y/%m/%d', verbose_name='Images is product')),
            ],
        ),
        migrations.CreateModel(
            name='ShippingAdress',
